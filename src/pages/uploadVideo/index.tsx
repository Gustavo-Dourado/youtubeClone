...
function UploadVideo(){
    ...
    function tryToUploadVideo(){
        ...
        if (isAllValid === false){
            ...
            createVideo(user_id, image, title, description, channel, views, uploadDate);          
        }
    }
            ...
            <>
                ...
                <MainContainer>
                    ...
                    <LoginContainer>
                      ...
                      <InputContainer>
                        <label htmlFor='description-video' id='description-video-id' className='label'>Descrição</label>
                        <textarea 
